...
#define PPM_SC_FIELDS \
	...
	PPM_SC_X(SPU_CREATE, 413) \
	PPM_SC_X(VM86, 414) \
	PPM_SC_X(OLDOLDUNAME, 415) \
	PPM_SC_X(PCICONFIG_READ, 416) \
	PPM_SC_X(SWITCH_ENDIAN, 417) \
	PPM_SC_X(SYNC_FILE_RANGE2, 418) \
	PPM_SC_X(SYS_DEBUG_SETCONTEXT, 419) \
	PPM_SC_X(SPU_RUN, 420) \
	PPM_SC_X(FCHMODAT2, 421) \
	PPM_SC_X(SUBPAGE_PROT, 422) \
	PPM_SC_X(OLDFSTAT, 423) \
	PPM_SC_X(PCICONFIG_WRITE, 424) \
	PPM_SC_X(PCICONFIG_IOBASE, 425) \
	PPM_SC_X(OLDSTAT, 426) \
	PPM_SC_X(MULTIPLEXER, 427) \
	PPM_SC_X(SWAPCONTEXT, 428) \
	PPM_SC_X(RTAS, 429) \
	PPM_SC_X(MAP_SHADOW_STACK, 430) \
	PPM_SC_X(OLDLSTAT, 431)
